...
<html>
<head>
	<title><sitemesh:title default="欢迎光临"/> - ${site.title} - Powered By Cooperation</title>
...
<body>
      ...
      <div class="navbar-inner">
        <div class="container">
          ...
          <div class="nav-collapse">
            ...
            <form class="navbar-form pull-right" action="${ctx}/search" method="post">
	...
	<div class="container">
		...
		<footer>
			<div class="footer_nav"><a href="${ctx}/guestbook" >公共留言</a> | <a href="${ctx}/search" >全站搜索</a> | <a href="${ctx}/map-${site.id}${fns:getUrlSuffix()}" >站点地图</a> | <a href="mailto:wang.zhen@ustcinfo.com">技术支持</a> | <a href="${pageContext.request.contextPath}${fns:getAdminPath()}" >后台管理</a></div>
