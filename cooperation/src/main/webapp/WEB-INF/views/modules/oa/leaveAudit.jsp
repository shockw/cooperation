...
<body>
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="#"><shiro:hasPermission name="oa:testAudit:edit">${leave.act.taskName}</shiro:hasPermission><shiro:lacksPermission name="oa:testAudit:edit">查看</shiro:lacksPermission></a></li>
	</ul>
