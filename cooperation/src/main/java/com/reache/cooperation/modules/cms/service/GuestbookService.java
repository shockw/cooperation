...
import com.reache.cooperation.modules.cms.dao.GuestbookDao;
...
//		return dao.find(page, dc);
	...
	public Page<Guestbook> search(Page<Guestbook> page, String q, String beginDate, String endDate){
		...
		List<Guestbook> guestbooks = dao.findFullText(q);
		if (guestbooks != null && guestbooks.size() > 0) {
			page.setCount(guestbooks.size());
