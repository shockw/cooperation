 ...
 */
package com.reache.cooperation.test.web;
...
import com.reache.cooperation.test.entity.TestDataMain;
import com.reache.cooperation.test.service.TestDataMainService;
...
public class TestDataMainController extends BaseController {
	...
	public String list(TestDataMain testDataMain, HttpServletRequest request, HttpServletResponse response, Model model) {
		...
		return "cooperation/test/testDataMainList";
	}
	...
	public String form(TestDataMain testDataMain, Model model) {
		...
		return "cooperation/test/testDataMainForm";
	}
